...
<html>
	<head>
		<title>Sign Up / Login - WFM Grocery List</title>
...
<div>
<form enctype="multipart/form-data" action="signup.php" method="POST" id="form-381326308567033343">
<div id="381326308567033343-form-parent" class="wsite-form-container" style="margin-top:10px;">
  <ul class="formlist" id="381326308567033343-form-list">
    <h2 class="wsite-content-title" style="text-align:left;">Sign Up</h2>

<div><div class="wsite-form-field wsite-name-field" style="margin:5px 0px 5px 0px;">
				<label class="wsite-form-label" for="input-105745566909714831">Name <span class="form-required">*</span></label>
				<div style="clear:both;"></div>
				<div class="wsite-form-input-container wsite-form-left wsite-form-input-first-name">
					<input id="firstname" class="wsite-form-input wsite-input" type="text" name="firstname" />
					<label class="wsite-form-sublabel" for="firstname">First</label>
				</div>
				<div class="wsite-form-input-container wsite-form-right wsite-form-input-last-name">
					<input id="lastname" class="wsite-form-input wsite-input" type="text" name="lastname" />
					<label class="wsite-form-sublabel" for="lastname">Last</label>
				</div>
				<div id="instructions-105745566909714831" class="wsite-form-instructions" style="display:none;"></div>
			</div>
...
<div><div class="wsite-form-field" style="margin:5px 0px 5px 0px;">
				...
				<div class="wsite-form-input-container">
					<input id="email" class="wsite-form-input wsite-input wsite-input-width-370px" type="text" name="email" />
				</div>
				</div></div>
...
<div style="text-align:left; margin-top:10px; margin-bottom:10px;">
  ...
  <input type="hidden" name="ucfid" value="381326308567033343" />
  <input type='submit' style='position:absolute;top:0;left:-9999px;width:1px;height:1px' /><a class='wsite-button' onclick="document.getElementById('form-381326308567033343').submit()"><span class='wsite-button-inner'>Submit</span></a>
</div>
</form>
