...
<div><div class="wsite-form-field" style="margin:5px 0px 5px 0px;">
				<label class="wsite-form-label" for="listname">Name your list <span class="form-required">*</span></label>
				<div class="wsite-form-input-container">
					<input id="listname" class="wsite-form-input wsite-input wsite-input-width-370px" type="text" name="listname" />
				</div>
				
			</div></div>

<div><div class="wsite-form-field" style="margin:5px 0px 5px 0px;">
				<label class="wsite-form-label" for="items">Enter grocery items </label>
				<div class="wsite-form-input-container">
					<input id="item1" class="wsite-form-input wsite-input wsite-input-width-370px" type="text" name="item_1" />
				</div>
				<div class="wsite-form-input-container">
					<input id="item2" class="wsite-form-input wsite-input wsite-input-width-370px" type="text" name="item_2" />
				</div>
				<div class="wsite-form-input-container">
					<input id="item3" class="wsite-form-input wsite-input wsite-input-width-370px" type="text" name="item_3" />
				</div>
				<div class="wsite-form-input-container">
					<input id="item4" class="wsite-form-input wsite-input wsite-input-width-370px" type="text" name="item_4" />
				</div>
				<div class="wsite-form-input-container">
					<input id="item5" class="wsite-form-input wsite-input wsite-input-width-370px" type="text" name="item_5" />
				</div>
				<div class="wsite-form-input-container">
					<input id="item6" class="wsite-form-input wsite-input wsite-input-width-370px" type="text" name="item_6" />
				</div>
				</div></div>
  </ul>
</div>
